...
resource "aws_efs_file_system" "efs1" {
   depends_on = [aws_security_group.my_security1 , aws_instance.myin ,]
...
resource "aws_s3_bucket_object" "object"{
  ...
  acl = "public-read"
  key = "sample.png"
  source = "C:/Users/mangl/Desktop/terraform/task2/images/sample.png"
...
resource "null_resource" "nullremote3" {
  depends_on = [aws_efs_mount_target.EFS_mount,aws_instance.myin]
  connection {
    type = "ssh"
    user = "ec2-user"
    private_key = file("C:/Users/mangl/Downloads/AWS-key.pem")
